...
function Select(props) {
    ...
    return (React.createElement("div", { className: classnames },
        ...
        showModal && (React.createElement(Modal, { title: "", onClose: function () { return setShowModal(false); }, type: "fullscreen" },
            React.createElement(ModalSelect, { onSelect: onSelect, label: label, options: options || [], asyncOptions: asyncOptions, asyncOnSearch: asyncOnSearch, placeholderSearch: placeholderSearch, onFilter: onFilter, errorComponent: errorComponent, buttonRefreshText: buttonRefreshText })))));
}
