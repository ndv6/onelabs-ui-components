...
function Select(props) {
    var _a;
    var label = props.label, className = props.className, loading = props.loading, error = props.error, required = props.required, placeholder = props.placeholder, onChange = props.onChange, value = props.value, options = props.options, groupOptions = props.groupOptions, asyncOptions = props.asyncOptions, asyncOnSearch = props.asyncOnSearch, onFilter = props.onFilter, defaultValue = props.defaultValue, disabled = props.disabled, native = props.native, placeholderSearch = props.placeholderSearch, errorComponent = props.errorComponent, buttonRefreshText = props.buttonRefreshText, rest = __rest(props, ["label", "className", "loading", "error", "required", "placeholder", "onChange", "value", "options", "groupOptions", "asyncOptions", "asyncOnSearch", "onFilter", "defaultValue", "disabled", "native", "placeholderSearch", "errorComponent", "buttonRefreshText"]);
    ...
    return (React.createElement("div", { className: classnames },
        ...
        showModal && (React.createElement(Modal, { title: "", onClose: function () { return setShowModal(false); }, type: "fullscreen" },
            React.createElement(ModalSelect, { onSelect: onSelect, label: label, options: options || [], groupOptions: groupOptions || {}, asyncOptions: asyncOptions, asyncOnSearch: asyncOnSearch, placeholderSearch: placeholderSearch, onFilter: onFilter, errorComponent: errorComponent, buttonRefreshText: buttonRefreshText })))));
}
